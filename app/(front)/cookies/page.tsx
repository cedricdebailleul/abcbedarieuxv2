...
const cookieCategories = [
  ...
  },
  {
    ...
    description: "Ces cookies permettent de personnaliser les contenus et publicités.",
    icon: Target,
    required: false,
    enabled: false,
    cookies: [
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Configurez vos préférences pour les cookies et traceurs utilisés sur notre site
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-4 gap-8">
                ...
                <Card key={category.id} className="border-l-4 border-l-primary">
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-3">
                      <h4 className="font-medium text-sm">Cookies concernés :</h4>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <ul className="text-xs text-muted-foreground space-y-1">
                  ...
                  <li>• <strong>Persistants :</strong> Conservés jusqu'à expiration</li>
                  <li>• <strong>Première partie :</strong> Émis par notre site</li>
                  <li>• <strong>Tiers :</strong> Émis par des partenaires</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Vous pouvez modifier vos préférences à tout moment depuis cette page.
              </p>
