            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-gray-500 text-center">
                  Vous pouvez vous réabonner à tout moment depuis notre site web.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-gray-600 text-center">
                Vous pouvez vous désabonner en utilisant votre adresse email ci-dessous.
              </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    Abonné depuis le {new Date(subscriber.subscribedAt).toLocaleDateString("fr-FR")}
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  ...
                  <div className="text-sm text-amber-800">
                    ...
                    <p>
                      En vous désabonnant, vous ne recevrez plus nos informations sur les événements,
                      nouveaux commerces et actualités de l'association.
                    </p>
                  </div>
                </div>
            ...
            <div className="text-xs text-gray-500 p-3 bg-blue-50 rounded border-l-4 border-blue-200">
              <strong>Informations RGPD :</strong> Vos données personnelles seront conservées de manière
              sécurisée mais marquées comme inactives. Vous pouvez vous réabonner à tout moment.
              Pour une suppression complète de vos données, contactez-nous via notre 
